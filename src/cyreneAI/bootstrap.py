...
async def build_cyrene_ai_runtime(
    *,
    ...
    runtime = await build_application_runtime(
        ...
        plugin_task_max_concurrent_tasks=plugin_task_max_concurrent_tasks,
        plugin_task_lease_owner=plugin_task_lease_owner,
        plugin_task_lease_seconds=plugin_task_lease_seconds,
