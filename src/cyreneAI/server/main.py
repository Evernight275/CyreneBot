...
async def _build_runtime():
    return await build_cyrene_ai_runtime(
        ...
        qq_bot_token=build_qq_bot_token_from_env(),
        qq_bot_app_id=build_qq_bot_app_id_from_env(),
        qq_bot_app_secret=build_qq_bot_app_secret_from_env(),
        qq_bot_base_url=build_qq_bot_base_url_from_env(),
        qq_bot_token_url=build_qq_bot_token_url_from_env(),
...
def _build_app():
    return create_app_with_runtime_builder(
        ...
        qq_webhook_secret=build_qq_webhook_secret_from_env(),
        qq_provider_id=build_qq_webhook_provider_id_from_env(),
        qq_model=build_qq_webhook_model_from_env(),
        qq_websocket_enabled=build_qq_websocket_enabled_from_env(),
